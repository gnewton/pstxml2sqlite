...
type Attachment struct {
	...
	Sha1Base64                       *Sha1Base64 `xml:" sha1Base64,omitempty" json:"sha1Base64,omitempty"`
}
...
type Message struct {
	...
	Received                  *Received       `xml:" received,omitempty" json:"received,omitempty"`
...
type Return_path struct {
	Text string `xml:",chardata" json:",omitempty"`
}

type Sha1Base64 struct {
	Text string `xml:",chardata" json:",omitempty"`
}
